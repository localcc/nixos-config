...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    environment.systemPackages =
      ...
      [
        swaylock # locker
        swayidle # idle daemon for apps to setgestures away status
    ...
    environment.etc."niri/config.kdl".text = ''
      ...
      binds {
          ...
          Mod+T hotkey-overlay-title="Open a Terminal" { spawn "rio"; }
          Mod+D hotkey-overlay-title="Run an Application" { spawn "anyrun"; }
